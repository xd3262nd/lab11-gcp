...
class TestWishList(TestCase):
    ...
    def test_view_wishlist(self):
        ...
        data_expected = list(Places.objects.filter(user=self.user).filter(visited=False))
    ...
    def test_view_places_visited(self):
        ...
        data_expected = list(Places.objects.filter(user=self.user).filter(visited=True))
        # Is it the same?
        self.assertCountEqual(data_rendered, data_expected)
...
class TestAddNewPlace(TestCase):
    ...
    def test_add_new_unvisited_place_to_wishlist(self):
        ...
        tokyo_in_database = Places.objects.get(name="Tokyo", visited=False)
        ...
        # the values expected. Will throw an exception if no data, or more than
        # one row, matches. Remember throwing an exception will cause this test to fail
        place_in_database = Places.objects.get(name="Yosemite", visited=False)
        place_in_database = Places.objects.get(name="Tokyo", visited=False)

        places_in_database = Places.objects.all()  # Get all data
    ...
    def test_add_new_visited_place_to_wishlist(self):
        ...
        # the values expected. Will throw an exception if no data, or more than
        # one row, matches. Remember throwing an exception will cause this test to fail
        place_in_database = Places.objects.get(name="Tokyo", visited=True)
...
class TestDeletePlace(TestCase):
    ...
    def test_delete_own_place(self):
        ...
        place_2 = Places.objects.filter(pk=2).first()
    ...
    def test_delete_someone_else_place_not_auth(self):
        ...
        place_5 = Places.objects.get(pk=5)
...
class TestPlaceDetail(TestCase):
    ...
    def test_place_detail(self):
        place_1 = Places.objects.get(pk=1)
    ...
    def test_modify_notes(self):
        ...
        updated_place_1 = Places.objects.get(pk=1)
    ...
    def test_add_notes(self):
        ...
        updated_place_4 = Places.objects.get(pk=4)
